...
CATEGORY_MAP: dict[str, list[str]] = {
    ...
    "Documents": [".pdf", ".md", ".doc", ".docx", ".xls", ".xlsx", ".ppt", ".pptx", ".txt", ".rtf", ".odt", ".csv", ".pages", ".numbers", ".key", ".pem"],
    "Archives": [".zip", ".tar", ".gz", ".bz2", ".7z", ".rar", ".xz", ".tar.gz", ".tgz"],
    "Installers": [".dmg", ".pkg", ".app", ".exe", ".msi", ".deb", ".rpm"],
    "Code": [".py", ".ipynb", ".js", ".ts", ".jsx", ".tsx", ".java", ".c", ".cpp", ".h", ".go", ".rs", ".rb", ".sh", ".html", ".css", ".json", ".yaml", ".yml", ".toml", ".xml", ".sql", ".swift", ".kt"],
    "Data": [".db", ".jsonl", ".sqlite", ".sqlite3", ".parquet", ".arrow", ".feather", ".hdf5", ".h5"],
